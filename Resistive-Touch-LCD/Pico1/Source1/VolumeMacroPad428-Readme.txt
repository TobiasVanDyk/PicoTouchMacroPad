Compiled with Pico SDK 2.3.0, Arduino Pico 6.1.0 and included Adafruit_TinyUSB_Arduino 3.7.7, and TFTeSPI 2.5.44
...
Sketch uses 278172 bytes (26%) of program storage space. Maximum is 1044480 bytes.
Global variables use 71300 bytes (27%) of dynamic memory, leaving 190844 bytes for local variables. Maximum is 262144 bytes.
Resetting COM9
Converting to uf2, output size: 636416, start address: 0x2000
Scanning for RP2040 devices
Flashing G: (RPI-RP2)
Wrote 636416 bytes to G:/NEW.UF2
----------------------------------------------------------------------------------------------------------------
...
5. Arduino Pico 6.1.0 and Pico SDK 2.3.1 and nKeysL134 = false CheckSerial = true KeyHeldEnable = false as defaults
